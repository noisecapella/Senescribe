...
class UserControllerTest < ActionController::TestCase
  fixtures :users
  #CREATE
  test "create_with_empty_openid" do
    get :create 
    assert_redirected_to_index "OpenID authentication failed: OpenID URL is empty"
  end

  #test "create_with_url_which_is_not_a_openid_server" do
  #  get :create, { :openid_url => "www.google.com"}
  #  assert_redirected_to_index "Sorry, the OpenID server couldn't be found"
  #end
  
  #test "create_with_invalid_url" do
  ...
  test "profile_view_without_id" do
    get :profile
    
    assert_redirected_to_index("Couldn't find user without an ID")
  end

  test "profile_view_of_invalid_id" do
    assert_raise(ActiveRecord::RecordNotFound) do
      get :profile, {:id => 0}
    end
  end
  ...
  #CREATE_NEW_USER
  test "create_new_user_without_being_authenticated" do
  ...
  #UPDATE
  test "update_while_logged_in_as_different_user" do
    user = User.find_by_description("George")
  ...
  test "update_while_not_logged_in" do
    user = User.find_by_description("George")
    params = {:user => {:email => "t", :description => "u"},
      :id => user.id}
    get :update, params
  ...
  test "update_invalid_user_id" do
    params = {:user => {:email => "t", :description => "u"},
      :id => -1}
    session = {:user_id => -1}
  ...
  test "update_with_missing_email" do
    user = User.find_by_description("George")
